...
import org.audiveris.omr.score.entity.LyricsItem;
import org.audiveris.omr.score.entity.Measure;
import org.audiveris.omr.score.entity.MeasureId.MeasureRange;
import org.audiveris.omr.score.entity.Notation;
...
import org.audiveris.omr.score.entity.Voice.VoiceChord;
import org.audiveris.omr.score.entity.Wedge;
import org.audiveris.omr.score.midi.MidiAbstractions;
        ...
        extends AbstractScoreVisitor
{
    ...
    public boolean visit (Arpeggiate arpeggiate)
    {
        try {
            ...
            org.audiveris.proxymusic.Arpeggiate pmArpeggiate = factory.createArpeggiate();
    ...
    public boolean visit (Barline barline)
    {
        try {
            ...
            if ((shape != org.audiveris.omr.glyph.Shape.THIN_BARLINE)
                && (shape != org.audiveris.omr.glyph.Shape.PART_DEFINING_BARLINE)) {
                try {
                    org.audiveris.proxymusic.Barline pmBarline = factory.createBarline();
                    org.audiveris.proxymusic.BarStyleColor barStyleColor = factory.
                            createBarStyleColor();
    ...
    public boolean visit (Coda coda)
    {
        try {
            ...
            org.audiveris.proxymusic.EmptyPrintStyleAlign pmCoda = factory.createEmptyPrintStyleAlign();
            // default-x
            pmCoda.setDefaultX(
                    toTenths(
            ...
            sound.setDivisions(new BigDecimal(
                    score.simpleDurationOf(org.audiveris.omr.score.entity.Note.QUARTER_DURATION)));
    ...
    public boolean visit (ChordSymbol symbol)
    {
        try {
            ...
            org.audiveris.omr.score.entity.ChordInfo info = symbol.getInfo();
            Staff staff = current.note.getStaff();
            ...
            // Degrees?
            for (org.audiveris.omr.score.entity.ChordInfo.Degree deg : info.getDegrees()) {
    ...
    public boolean visit (Dynamics dynamics)
    {
        try {
            ...
            Direction direction = factory.createDirection();
            DirectionType directionType = factory.createDirectionType();
            org.audiveris.proxymusic.Dynamics pmDynamics = factory.createDynamics();
    ...
    public boolean visit (Fermata fermata)
    {
        try {
            ...
            org.audiveris.proxymusic.Fermata pmFermata = factory.createFermata();
    ...
    public boolean visit (Measure measure)
    {
        try {
            ...
            if (isFirst.page && isFirst.system && isFirst.measure) {
                try {
                    getAttributes().setDivisions(new BigDecimal(
                            score.simpleDurationOf(org.audiveris.omr.score.entity.Note.QUARTER_DURATION)));
                } catch (Exception ex) {
    ...
    //------------//
    @Override
    public boolean visit (org.audiveris.omr.score.entity.Note note)
    {
        try {
            ...
            if (chord.getNotes().indexOf(note) == 0) {
                ...
                for (org.audiveris.omr.score.entity.Direction node : chord.getDirections()) {
                    node.accept(this);
                }
                // Chord symbol, if any
            ...
            for (Beam beam : chord.getBeams()) {
                org.audiveris.proxymusic.Beam pmBeam = factory.createBeam();
    ...
    public boolean visit (Pedal pedal)
    {
        try {
            ...
            DirectionType directionType = new DirectionType();
            org.audiveris.proxymusic.Pedal pmPedal = new org.audiveris.proxymusic.Pedal();
    ...
    public boolean visit (Score score)
    {
        try {
            ...
            // [Defaults]/LyricFont
            Font lyricFont = org.audiveris.omr.score.entity.Text.getLyricsFont();
            LyricFont pmLyricFont = factory.createLyricFont();
            pmLyricFont.setFontFamily(lyricFont.getName());
            pmLyricFont.setFontSize("" + org.audiveris.omr.score.entity.Text.getLyricsFontSize());
    ...
    public boolean visit (Slur slur)
    {
        try {
            ...
            if (slur.isTie()) {
                ...
                // Slur element
                org.audiveris.proxymusic.Slur pmSlur = factory.createSlur();
    ...
    public boolean visit (Tuplet tuplet)
    {
        try {
            ...
            org.audiveris.proxymusic.Tuplet pmTuplet = factory.createTuplet();
    ...
    public boolean visit (Wedge wedge)
    {
        try {
            ...
            Direction direction = factory.createDirection();
            DirectionType directionType = factory.createDirectionType();
            org.audiveris.proxymusic.Wedge pmWedge = factory.createWedge();
    ...
    // buildClef //
    //-----------//
    private org.audiveris.proxymusic.Clef buildClef (Clef clef)
    {
        org.audiveris.proxymusic.Clef pmClef = factory.createClef();
     ...
     */
    private org.audiveris.proxymusic.ScorePart getScorePart (ScorePart scorePart)
    {
        ...
        org.audiveris.proxymusic.ScorePart pmScorePart = factory.createScorePart();
    ...
    private static class Current
    {
        ...
        // Score dependent
        org.audiveris.proxymusic.Work pmWork;

        // Part dependent
        ScorePart scorePart;

        org.audiveris.proxymusic.ScorePartwise.Part pmPart;
        ...
        org.audiveris.proxymusic.ScorePartwise.Part.Measure pmMeasure;

        Voice voice;

        // Note dependent
        org.audiveris.omr.score.entity.Note note;

        org.audiveris.proxymusic.Note pmNote;

        org.audiveris.proxymusic.Notations pmNotations;

        org.audiveris.proxymusic.Attributes pmAttributes;
    ...
    private class MeasurePrint
    {
        ...
        private final org.audiveris.proxymusic.Print pmPrint;
        ...
        private org.audiveris.proxymusic.Print getPrint ()
        {
            used = true;
            return pmPrint;
        }
        ...
        private void populatePrint ()
        {
            ...
            if (isFirst.system && isFirst.measure) {
                org.audiveris.proxymusic.MeasureNumbering pmNumbering =
