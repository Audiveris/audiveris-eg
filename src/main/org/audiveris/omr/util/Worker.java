 ...
 * {@link org.audiveris.omr.util.OmrExecutors#getCachedLowExecutor()} which provides
 * similar functionality plus has its lifecycle managed correctly when shutting down
 * the application.</p>
 *
